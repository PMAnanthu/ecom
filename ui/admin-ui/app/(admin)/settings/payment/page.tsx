...
export default function PaymentSettingsPage() {
  ...
  const load = useCallback(async () => {
    try {
      const r = await api.get('/payment/store-config');
    ...
    <div className="max-w-xl space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Configure your Razorpay account. Product sale payments from your store will go to this account.
        </p>
      </div>
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-semibold">Razorpay — Store Account</CardTitle>
